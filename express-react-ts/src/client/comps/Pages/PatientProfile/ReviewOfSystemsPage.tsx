...
export const ReviewOfSystemsPage: IndividualPatientProfile = ({
  ...
  function checkDependency(state: endocrineState | visionState, symptomName: string): boolean{
    return !(symptomName in dependencies) || dependencies[symptomName].reduce((_, elem: string) => !state[elem], true)
  }
                    ...
                    <br></br>
                    {
                      Object.keys(state[category]).map((symptomName) => {
                            ...
                            <div className='radio-group'>
                              <label>
                                <input 
                                  ...
                                  onClick={() => dispatch({category: category, symptomName: symptomName})}
                                />
                        ...
                        return (
                          <div className='radio-group'>
                            <label>
                              <p style={{color: 'grey'}}>{nameMap[symptomName]}</p>
                            </label>
                          </div>
                        )
                      })
